...
// Note: dial slots Delikatne and Ręczny/Wełna share 0x20 — distinguished by inner[62]
// in status packet (Delikatne=0x07, Ręczny/Wełna=0x05). Cannot be reproduced by F025.
...
const COURSES: Record<number, string> = {
    ...
    0x05: 'Drum Clean',          // verified (dial: Czyszczenie bębna)
    0x07: 'Mixed',               // verified (dial: Mieszane)
    0x08: 'Speed 14',            // verified (dial: Szybki 14)
    0x0C: 'Bedding',             // verified (dial: Pościel, also base for Small Load/Single Garment CC)
    0x1B: 'Sportswear',          // verified (dial: Odzież sportowa, also base for Swimming Wear CC)
    0x20: 'Delicates',           // verified (dial: Delikatne; Ręczny/Wełna also uses 0x20 with different inner[62])
    0x2D: 'Hygiene',             // verified (dial: Antyalergiczny, auto-steam, also base for Hygiene CC)
